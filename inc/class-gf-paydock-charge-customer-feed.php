<?php
//add_filter( 'gform_pre_render',  'gf_paydock_parse_charge_form' );

// function gf_paydock_parse_charge_form( $form ) {
//  echo '<pre>';
//  print_r( $form ); die;
//  if ( !empty( $form['enable_paydock_charge'] ) ) {
...
//add_action( 'gform_after_submission', 'gf_paydock_maybe_charge_customer', 10, 2 );
function gf_paydock_maybe_charge_customer( $entry, $form ) {
